...
%% B5 paper size is chosen because A4 stock cuts down nicely to a B5 book that fits on a shelf nicely.
...
%% and include the appendices in separate files if you so wish
\appendix{}%%RUM: "Appendicies (as appropriate)
\input{code} % as an example, perhaps some of your code

%% Chicago Manual of Style says that the references go last
